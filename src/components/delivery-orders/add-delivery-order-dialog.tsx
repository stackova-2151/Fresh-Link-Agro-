...
import type { DeliveryOrder, RentalItem, Client } from '@/lib/types';
...
export function AddDeliveryOrderDialog({
  clients,
  rentalItems,
  onOrderAdded,
}: AddDeliveryOrderDialogProps) {
  ...
  const clientInwardItems = rentalItems.filter(
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={setSelectedInwardId}
                disabled={!clientId}
                required
              >
                <SelectTrigger id="inwardRef">
                  <SelectValue
                    placeholder={clientId ? 'Select inward stock' : 'Select client first'}
                  />
                </SelectTrigger>
                <SelectContent>
