...
import { GoodsReceiptNote, Client } from '@/lib/types';
...
export function AddGRNDialog({ onGRNAdded }: AddGRNDialogProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const newGRN: GoodsReceiptNote = {
      ...
      date: new Date(),
      clientId,
      address: clients.find(c => c.id === clientId)?.address || 'N/A',
      driverName,
      vehicleNumber,
      gatePassNumber,
      items: [
        ...
        <form onSubmit={handleSubmit}>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="itemName" value={itemName} onChange={(e) => setItemName(e.target.value)} placeholder="e.g., WHIIP CREAM" required />
              </div>
