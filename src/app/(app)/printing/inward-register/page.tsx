...
function buildPrintUrl(params: { customerId?: string; from?: string; to?: string }) {
  ...
  return `/printing/inward-register/print${qs ? `?${qs}` : ''}`;
}

export default function InwardRegisterFilterPage() {
  ...
  return (
    <div className="space-y-6">
      <PageHeader title="Inward Register" description="Filter and print inward register from saved inward vouchers." />
